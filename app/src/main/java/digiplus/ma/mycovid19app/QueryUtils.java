...
import static digiplus.ma.mycovid19app.MainActivity.LOG_TAG;
...
public final class QueryUtils {
     ...
     */
    public static List<MyDATA> fetchNewsData(String requestUrl) {
        // Create URL object
        ...
        List<MyDATA> news = extractResultsFromJson(jsonResponse);
     ...
     */
    private static List<MyDATA> extractResultsFromJson(String newsJSON) {
        ...
        List<MyDATA> news = new ArrayList<>();
        ...
        try {
            ...
            for (int i = 0; i < resultsArray.length(); i++) {
                ...
                MyDATA newsObj = new MyDATA(sectionName, authorName, webTitle, webPublicationDate, webUrl);
